...
@section('title', 'Script - Cassino Online | (66) 98101-5430 joguinho.shop ')
        ...
        <div class="page__content">
            ...
            <section class="modelo-destaque-jogos">
                    ...
                    <div class="splide__track">
                        <ul class="splide__list">
                            <li class="splide__slide">
                                <a href="{{ url('/') }}">
                                    <img src="{{ asset('assets/images/banner-sub.png') }}" alt="">
                                </a>
                            </li>
                            <li class="splide__slide">
                                <a href="{{ url('/') }}">
                            ...
                            <li class="splide__slide">
                                <a href="">
                                    <img src="{{ asset('/assets/images/banner-frut.jpg') }}" alt="">
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                @if(count($gamesExclusives) > 0)
                    ...
                    <div class="row mt-2">
                        <div class="col-lg-4 mb-3">
                            <a href="{{ url('/') }}"><img src="{{ asset('assets/images/fortuneox.png') }}" alt="" class="img-fluid rounded-4 w-full"></a>
                        </div>
                        <div class="col-lg-4 mb-3">
                            <a href="{{ url('/') }}"><img src="{{ asset('assets/images/mario.png') }}" alt="" class="img-fluid rounded-4 w-full"></a>
                        </div>
                        <div class="col-lg-4 mb-3">
                            <a href="{{ url('/') }}"><img src="{{ asset('assets/images/subaway.png') }}" alt="" class="img-fluid rounded-4 w-full"></a>
                        </div>
                    </div>
                ...
                <div class="mt-5">
                        @include('includes.title', ['link' => url('/'), 'title' => 'Jogos Money', 'icon' => 'far fa-sack-dollar'])
                </div>
